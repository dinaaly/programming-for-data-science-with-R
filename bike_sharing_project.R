...
#Now we have our three datasets chicago, newyork and washington on which we will perform the exploratory analysis and answer some questio


chicago %>% group_by(Gender) %>% filter(!is.na(Gender))%>% summarise(total = length(Gender))%>%
...
#What is the most common day of week?
 ...
 ggplot(chicago, aes(day)) + geom_bar()+ xlab("Weekdays") +  ylab("Count")+ ggtitle("Popular Weekdays in Chicago")
